...
<TestClass()> Public Class TestProcessInfo
    <TestMethod()> Public Sub TestDefaultConstructor()
        ...
        Dim tst As VWContractValidationPrompt.ProcessInfo = VWContractValidationPrompt.ProcessInfo.Fetch(pRun, cRun)
    ...
    <TestMethod()> Public Sub TestCountry()
        ...
        Dim tst2 As VWContractValidationPrompt.ProcessInfo = VWContractValidationPrompt.ProcessInfo.Fetch(pRun2, cRun2)
        ...
        Dim tst3 As VWContractValidationPrompt.ProcessInfo = VWContractValidationPrompt.ProcessInfo.Fetch(pRun3, cRun3)
    ...
    <TestMethod()> Public Sub TestApplicationType()
        ...
        Dim tst2 As VWContractValidationPrompt.ProcessInfo = VWContractValidationPrompt.ProcessInfo.Fetch(pRun, cRun)
        Assert.AreEqual("INDIVIDUAL AND TWO COAPPLICANTS", tst2.ApplicationType, True)
        cRun.Add("BUY_ISBUSINESS", True)
        Dim tst3 As VWContractValidationPrompt.ProcessInfo = VWContractValidationPrompt.ProcessInfo.Fetch(pRun, cRun)
        Assert.AreEqual("BUSINESS WITH TWO COAPPLICANTS", tst3.ApplicationType, True)
        cRun("COBUYER2_CODE") = ""
        Dim tst4 As VWContractValidationPrompt.ProcessInfo = VWContractValidationPrompt.ProcessInfo.Fetch(pRun, cRun)
